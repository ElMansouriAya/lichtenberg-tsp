function [best,fmin,n_iter,state,population]=LA_optimization(fhandle,d,im,n,LB,UB,ref,n_iter,Np,Rc,S_c,M,fnonlin)
for i=1:n
    Individuals(i,:)=LB+(UB-LB).*rand(1,d);
    Fitness(i)=Fun(fhandle,fnonlin,Individuals(i,:));
end
[fmin,I]=min(Fitness);
best=Individuals(I,:);
S=Individuals;
