...
- Integration with Lin-Kernighan heuristics
...
```bibtex
@misc{elmansouri2026lichtenberg,
  author = {Aya El Mansouri},
  title = {Hybrid Lichtenberg Algorithm for the Traveling Salesman Problem},
  year = {2026},
  note = {Research reproduction and hybrid extension},
  url = {https://github.com/ElMansouriAya/lichtenberg-tsp}
}
```
...
AI Research Engineer • Artificial Intelligence & Data Science
...
GitHub:
https://github.com/ElMansouriAya
